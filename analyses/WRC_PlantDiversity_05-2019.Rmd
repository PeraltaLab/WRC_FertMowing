...
p2=ggplot(ditcheff,aes(x=Ditch,y=est,ymin=lwr,ymax=upr,group=Ditch))+geom_segment(x=1,y=dd$effect[1],xend=2,yend=dd$effect[2],size=1)+geom_point(size=3)+theme_bw()+geom_linerange(size=.5)+theme_bw()+ylab("Species Richness")+
...
p1 + theme_bw() + 
    ...
    theme(axis.ticks.length=unit(0.3,"cm")) + labs(x = "Year", y = "Plant Biomass (g)") + 

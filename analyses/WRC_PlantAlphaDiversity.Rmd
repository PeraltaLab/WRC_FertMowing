...
p3.l <-p3 + theme(legend.position="top", legend.box = "horizontal") + 
            ...
            theme(axis.text=element_blank(), title=element_text(size=rel(1.25)), legend.text=element_text(size=rel(1.25)))
...
ggsave("../figures/All_Plant_Diversity.pdf", plot=last_plot(), device=NULL, path=NULL, scale=1,  width=7, height=14, dpi=300, limitsize=TRUE)
```
...
ggsave("../figures/plant_biomass.pdf", plot=last_plot(), device=NULL, path=NULL, scale=1, width=7, height=5, dpi=300, limitsize=TRUE)
...
ggsave("../figures/plant_biomass_boxplot.pdf", plot=last_plot(), device=NULL, path=NULL, scale=1, width=7, height=5, dpi=300, limitsize=TRUE)
```